...
@Component({
  selector: 'app-albaran-imprimir-proveedor-electroluga',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './albaran-imprimir-proveedor-electroluga.component.html',
  styleUrls: ['./albaran-imprimir-proveedor-electroluga.component.css'],
})
export class AlbaranImprimirProveedorElectrolugaComponent implements OnInit {
  /*
  ...
  cargarAlbaran(id: number): void {
    ...
    this.http.get<any>(`${this.baseUrl}/albaranes-proveedor/${id}`).subscribe({
      next: (data) => {
  ...
  getNombreReceptor(): string {
    ...
    return this.factura.nombre || this.factura.proveedor?.nombre || '—';
  }
